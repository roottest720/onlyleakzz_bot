...
#Bot token @Botfather
TG_BOT_TOKEN = os.environ.get("TG_BOT_TOKEN", "6931355424:AAGrCyDAYS69ZmcMsLptkMQuKYYkQ8ndSK0")
...
FORCE_SUB_CHANNEL = int(os.environ.get("FORCE_SUB_CHANNEL", "-1002049307595"))

TG_BOT_WORKERS = int(os.environ.get("TG_BOT_WORKERS", "4"))

#start message
START_MSG = os.environ.get("START_MESSAGE", "Hello {first}\n\nThis bot is file sending bot 😇\nPlease join our channel to use this bot 😊")
try:
    ADMINS=[]
